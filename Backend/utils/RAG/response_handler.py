...
from .responser.ollama_responser import OllamaResponser
from .responser.openai_responser import OpenAIResponser
from .responser.afs_responser import AFSResponser
from .responser.openai_compatible_responser import OpenaiCompatibleResponser
...
class ResponseHandler:
    def __init__(self) -> None:
        ...
        self.LLM_DEPLOY_MODE = DeployModel(mode=mode).mode.lower()
